...
import { motion, MotionStyle, Transition } from 'framer-motion'; // Corrected import from 'motion/react'
...
export const BorderBeam = ({
    ...
    delay = 0,
    duration = 6,
    // Updated default colors to a green theme.
    colorFrom = '#4ade80', // green-400
