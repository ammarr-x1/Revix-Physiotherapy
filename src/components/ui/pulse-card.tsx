...
interface CardProps {
    ...
    description: string;
    className?: string;
    // Updated variant options to a green-based theme.
    variant?: 'green' | 'teal' | 'emerald' | 'lime' | 'blue' | 'purple' | 'amber' | 'rose';
    size?: 'sm' | 'md' | 'lg';
    glowEffect?: boolean;
    hoverScale?: number;
    interactive?: boolean;
...
// Added new variants for the green theme.
export const VARIANTS = {
    green: {
        accent: 'green-500',
        gradient: 'from-green-500/20 to-green-500/0',
        shine:
            '205deg, transparent 0deg, hsl(145deg 95% 39%) 20deg, hsl(145deg 100% 85% / 0.3) 280deg',
        border: 'green-500/20',
        color: 'rgb(34 197 94)',
    },
    teal: {
        ...
        shine:
            '205deg, transparent 0deg, hsl(175deg 95% 39%) 20deg, hsl(175deg 100% 85% / 0.3) 280deg',
        border: 'teal-500/20',
    ...
    emerald: {
        ...
        shine:
            '205deg, transparent 0deg, hsl(140deg 95% 39%) 20deg, hsl(140deg 100% 85% / 0.3) 280deg',
    ...
    lime: {
        ...
        shine:
            '205deg, transparent 0deg, hsl(80deg 95% 39%) 20deg, hsl(80deg 100% 85% / 0.3) 280deg',
        border: 'lime-500/20',
